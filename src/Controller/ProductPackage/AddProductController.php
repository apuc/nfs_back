...
use App\DTO\Builder\ProductPackageProductCreateDTOBuilder;
...
class AddProductController extends AbstractController
{
    ...
    /**
     * Добавить продукт в пакет услуг.
     */
    #[Route('/api/catalog/product/add-product-to-package', methods: ['POST'])]
    #[Attributes\Response(
        response: 200,
        description: 'Success',
    ...
    #[Attributes\RequestBody(
        required: true,
        content: new Attributes\JsonContent(
            ref: new Model(type: ProductPackageProductCreateDTO::class)
        )
    )]
    #[Attributes\Tag(name: 'Product package')]
    public function create(Request $request): JsonResponse
    {
        $requestDTO = ProductPackageProductCreateDTOBuilder::build(
        ...
        return $response
            ...
            ->setData([
                'data' => $this->serializer->toArray(
                    $this->actionComponent->addProduct($requestDTO),
