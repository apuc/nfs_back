...
namespace App\Service\PartnerService\Component;
...
class PartnerActionComponent
{
    ...
    public function edit(PartnerEditDTO $requestDTO): PartnerDTO
    {
        ...
        if (null !== $partner) {
            ...
            $partner
                ->setTitle($requestDTO->getTitle() ?? $partner->getTitle())
                ->setOccupation($requestDTO->getOccupation() ?? $partner->getOccupation())
                ->setDetails([
                    PartnerConstants::DETAILS_KEY_INN => $requestDTO->getInn(
