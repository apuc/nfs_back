...
/**
 * Значение должно содержать идентификатор существующего ТСП.
 */
class PartnerExistsValidator extends ConstraintValidator
{
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$this->partnerService->findEntityById($value)) {
